...
char IS_BASIC = 0; //1 is true, 0 is false
...
const int SLOW_DIST = 45; //distance to start slowing` down is 10 cm
const int STOP_DIST = 5; //distance to stop is 6 cm FOR NOW, (improve later)
const int TURN_90_TIME = 310;//-------------------------------------------------------------------------------------------------------------------------delay here, change based on the battery levels (will need to be fine tuned before demo, was 220 earlier yesterday
