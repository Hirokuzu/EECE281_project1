...
float getDistance() {
  ...
  speedSoundComp = 331.5 + (0.6 * temperature);  //calculate speed of sound with temperature in m/s
  speedSoundComp = 10000/speedSound;             //convert speed of sound to us/cm
